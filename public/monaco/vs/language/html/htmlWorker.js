...
define('vs/language/html/htmlWorker', ['require', 'require'], require => {
  var moduleExports = (() => {
    ...
    (function (t) {
      ...
      function o(n) {
        var e = n;
        return _.defined(e) && we.is(e.location) && _.string(e.message);
      }
      t.is = o;
    })(Ke || (Ke = {}));
    var kt;
      ...
      function o(n) {
        ...
        return (
          ...
          (_.undefined(a.codeDescription) ||
            _.string(
              (e = a.codeDescription) === null || e === void 0
                ? void 0
                : e.href,
            )) &&
          (_.string(a.source) || _.undefined(a.source)) &&
          (_.undefined(a.relatedInformation) ||
            _.typedArray(a.relatedInformation, Ke.is))
        );
      }
      t.is = o;
    })(xe || (xe = {}));
    ...
    (function (t) {
      ...
      function e(a) {
        var c = a;
        return Y.is(c) && (ve.is(c.annotationId) || Z.is(c.annotationId));
      }
      t.is = e;
    })(ce || (ce = {}));
    var Be;
    ...
    (function (t) {
      ...
      function o(n) {
        ...
        return (
          ...
          (e.command === void 0 || ye.is(e.command)) &&
    ...
    (function (t) {
      ...
      function o(n) {
        ...
        return (
          _.defined(e) &&
          P.is(e.range) &&
          (_.undefined(e.command) || ye.is(e.command))
        );
      }
      t.is = o;
    })(Wt || (Wt = {}));
...
` &&
    ...
    (function (t) {
      function i(e, a, c, l) {
        return new pe(e, a, c, l);
      }
      t.create = i;
      function o(e, a, c) {
        if (e instanceof pe) return e.update(a, c), e;
        throw new Error(
            ...
            n.parent &&
              ...
              i.getTokenLength()
                ? ((n.startTagEnd = i.getTokenEnd()),
                  n.tag && me(n.tag) && ((n.closed = !0), (n = n.parent)))
                : (n = n.parent));
            break;
...
\r`.indexOf(L) >= 0
            ...
            function J(x, D) {
              ...
              if (!$t(s, D, W.AfterAttributeName, S.DelimiterAssign)) {
                var K =
                  (L = e?.attributeDefaultValue) !== null && L !== void 0
                    ? L
                    : 'doublequotes';
                K === 'empty'
                  ? (V = '=$1')
            ...
            function R() {
              for (var x = u - 1, D = o.character; x >= 0 && ge(s, x); )
                x--, D--;
              if (x >= 0 && s[x] === '&') {
                ...
                for (var q in fe)
                  if (Gt(q, ';')) {
                    ...
                    a.items.push({
                      ...
                      documentation: hi(
                        'entity.propose',
                        "Character entity representing '".concat(fe[q], "'"),
                      ),
          ...
          (t.prototype.doQuoteComplete = function (i, o, n, e) {
            ...
            if (c <= 0) return null;
            var l =
              (a = e?.attributeDefaultValue) !== null && a !== void 0
                ? a
                : 'doublequotes';
      ...
      Zt = (function () {
        ...
        return (
          (t.prototype.doHover = function (i, o, n, e) {
            ...
            function y(U, H) {
              ...
              for (var I in fe) {
                var F = null,
                  T = '&' + I;
                if (z === T) {
                  var v = fe[I].charCodeAt(0).toString(16).toUpperCase(),
                    k = 'U+';
                  if (v.length < 4)
                  ...
                  var D = fi(
                    ...
                    "Character entity representing '"
                      .concat(fe[I], "', unicode equivalent '")
                      .concat(k, "'"),
                  );
            ...
            function A() {
              for (var U = l - 1, H = o.character; U >= 0 && ge(s, U); )
                U--, H--;
              for (var z = U + 1, I = H; ge(s, z); ) z++, I++;
              if (U >= 0 && s[U] === '&') {
                var F = null;
                return (
                  s[z] === ';'
            ...
            function E(U) {
              for (var H = l - 1, z = '&'; H >= 0 && ge(U, H); ) H--;
              for (H = H + 1; ge(U, H); ) (z += U[H]), (H += 1);
              return (z += ';'), z;
            }
...
`.indexOf(t.charAt(i)) !== -1
        ...
        switch (e) {
          ...
          case S.AttributeValue:
            if (a === 'src' || a === 'href') {
              ...
              c &&
                typeof l > 'u' &&
                ((l = ft(u)), l && i && (l = i.resolveReference(l, t.uri))),
                (c = !1),
                (a = void 0);
            } else if (a === 'id') {
    ...
    function mn(t, i, o) {
      ...
      return (
        ((c && dn(c, i)) || (l && dn(l, i))) &&
          (c && a.push({ kind: Te.Read, range: c }),
          l && a.push({ kind: Te.Read, range: l })),
        a
      );
    }
    function hn(t, i) {
    ...
    function bn(t, i, o, n) {
      ...
      var l = [],
        r = {
          start: t.positionAt(c.start + 1),
          end: t.positionAt(c.start + 1 + c.tag.length),
        };
      if ((l.push({ range: r, newText: o }), c.endTagStart)) {
        var s = {
          start: t.positionAt(c.endTagStart + 2),
          end: t.positionAt(c.endTagStart + 2 + c.tag.length),
        };
    ...
    function gt(t, i, o) {
      ...
      return e.endTagStart &&
        ((e.start + 1 <= n && n <= e.start + 1 + a) ||
          (e.endTagStart + 2 <= n && n <= e.endTagStart + 2 + a))
        ? [
            P.create(t.positionAt(e.start + 1), t.positionAt(e.start + 1 + a)),
            P.create(
              t.positionAt(e.endTagStart + 2),
              t.positionAt(e.endTagStart + 2 + a),
            ),
          ]
        : null;
    }
        ...
        switch (n) {
          ...
          case S.Comment: {
            ...
            if (A)
              if (A[1]) a.push({ startLine: u, tagName: '' });
                ...
                if (h >= 0) {
                  ...
                  (u = d.startLine),
                    y > u &&
                      l !== u &&
                      r({ startLine: u, endLine: y, kind: _e.Region });
                }
              }
            else {
              var y = t.positionAt(
              ...
              u < y && r({ startLine: u, endLine: y, kind: _e.Comment });
            }
            break;
          }
        }
    ...
    function yn(t, i) {
      function o(n) {
        for (
          var e = Di(t, n), a = void 0, c = void 0, l = e.length - 1;
          l >= 0;
          l--
        ) {
          var r = e[l];
        ...
        return c || (c = ke.create(P.create(n, n))), c;
      }
      return i.map(o);
    }
    function Di(t, i) {
